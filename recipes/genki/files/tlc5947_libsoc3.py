...
class tlc5947():
    #def __init__(self,spiport=0,latchpin=18):
    def __init__(self,spiport=0,latchpin=108,blankpin=101):
...
def selftest(testmode = "testchannels"):
    ...
    elif testmode == "rgbchannel":
        tlc_obj.write_pwm([(0,maxdim),(1,0),(2,0)])#red
        time.sleep(1)
        tlc_obj.write_pwm([(3,0),(4,maxdim),(5,0)])#green
        time.sleep(1)
        tlc_obj.write_pwm([(6,0),(7,0),(8,maxdim)])#blue
        time.sleep(1)
        tlc_obj.write_pwm([(9,maxdim),(10,maxdim),(11,0)])#red and green = yellow
        time.sleep(1)
        tlc_obj.write_pwm([(12,maxdim),(13,0),(14,maxdim)])#red and blue = violett
        time.sleep(1)
        tlc_obj.write_pwm([(15,0),(16,maxdim),(17,maxdim)])#green and blue = celeste
        time.sleep(1)
        tlc_obj.write_pwm([(18,maxdim),(19,maxdim),(20,maxdim)])#red,green and blue = white
